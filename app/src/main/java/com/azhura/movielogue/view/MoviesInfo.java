...
import com.azhura.movielogue.adapter.CastsAdapter;
import com.azhura.movielogue.adapter.ReviewsAdapter;
import com.azhura.movielogue.adapter.TrailerAdapter;
import com.azhura.movielogue.config.BuildConfigs;
import com.azhura.movielogue.databinding.ActivityMoviesInfoBinding;
import com.azhura.movielogue.model.tmdb.Cast;
import com.azhura.movielogue.model.tmdb.CastsList;
import com.azhura.movielogue.model.tmdb.Genre;
import com.azhura.movielogue.model.tmdb.Movie;
import com.azhura.movielogue.model.tmdb.Review;
import com.azhura.movielogue.model.tmdb.ReviewsList;
import com.azhura.movielogue.model.tmdb.Trailer;
import com.azhura.movielogue.service.TorrentFetcherService;
import com.azhura.movielogue.service.network.RetrofitInstance;
import com.azhura.movielogue.service.network.TMDbService;
import com.azhura.movielogue.utils.PaginationScrollListener;
import com.azhura.movielogue.viewmodel.MainViewModel;
...
public class MoviesInfo extends AppCompatActivity implements TorrentFetcherService.OnCompleteListener {
    ...
    private TrailerApiList trailers = new TrailerApiList();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        trailers.setTrailer(new ArrayList<Trailer>());
        ...
        trailersRecyclerView = activityMoviesInfoBinding.secondaryLayout.listOfTrailers;
...
//        getTrailers();
        ...
        activityMoviesInfoBinding.secondaryLayout.txtSeaAll.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void getTrailers1() {
        Observable<TrailerApiList> trailerapiList = tMDbService.getTrailers1(movie.getId(), ApiKey).doOnError(new Consumer<Throwable>() {
            @Override
            public void accept(Throwable throwable) throws Exception {
                getParcelableData();
            }
        });
        compositeDisposable.add(trailerapiList.subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribeWith(
                new DisposableObserver<TrailerApiList>() {
                    @Override
                    public void onNext(TrailerApiList trailerapiList) {
                        if (trailerapiList != null && trailerapiList.getTrailers() != null) {
                            trailers = trailerapiList;
        ...
        trailerViewModel.getAllTrailers().observe(this, new Observer<List<Trailer>>() {
            ...
            public void onChanged(@Nullable List<Trailer> trailers) {
                ...
                if (trailers != null && trailers.isEmpty()) {
                    ...
                    activityMoviesInfoBinding.secondaryLayout.noTrailers.setVisibility(View.VISIBLE);
                }
